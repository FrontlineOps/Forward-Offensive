...
FLO_ObjectiveGridInfluenceRate = 0.008;
FLO_ObjectiveGridEncirclementRate = 0.012;
FLO_ObjectiveGridAoEMinOwnedNeighbors = 2;
FLO_ObjectiveGridEncircleMinOwnedNeighbors = 5;
FLO_ObjectivePerfLogThresholdMs = 20;
FLO_ObjectiveGeneratedMaxObjectives = 40;
FLO_ObjectiveGeneratedMinSpacing = 1200;
FLO_ObjectiveGeneratedObjectiveGridRadius = 900;
